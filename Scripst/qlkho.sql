...
go
insert into Users(DisplayName, Username, Password, IdRole) values(N'haichau', N'admin', N'db69fc039dcbd2962cb4d28f5891aae1', 1)
go
...
(
	...
	foreign key (IdObject) references Object(Id),
	foreign key (IdOutputInfor) references Output(Id),
